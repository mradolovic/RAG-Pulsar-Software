...
tk.Radiobutton(chain_frame, text="Chain 1  (rtl_sdr → RTLChannel4bin → pulsar_det_an → pul_plot)",
               variable=var_chain, value=1).grid(row=0, column=0, sticky="w", padx=8)
tk.Radiobutton(chain_frame, text="Chain 2  (not yet implemented)",
               variable=var_chain, value=2, state="disabled").grid(row=1, column=0, sticky="w", padx=8)
...
tk.Label(sel_frame, text="Valid chains:  1→2→3→4  |  2→3→4  |  3→4  only",
         font=("TkDefaultFont", 10), fg="#666666").grid(
