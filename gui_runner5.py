...
tk.Label(
    title_frame,
    text="RAG Pulsar Detection Pipeline",
    font=("TkDefaultFont", 16, "bold"),
).pack(side="left")

tk.Label(
    title_frame,
    text="RAG_Pulsar_Software.py",
    font=("TkDefaultFont", 9),
    fg="#666666",
).pack(side="left", padx=(12, 0), anchor="s", pady=(0, 3))
...
# =============================
# pul_plot  (display only)
# =============================
pulplot_frame = tk.LabelFrame(main, text="pul_plot", padx=10, pady=10)
pulplot_frame.pack(fill="x", pady=5)
