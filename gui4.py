...
make_section_info_button(topo_frame, "TopoBary", anchor="e")
...
make_section_info_button(frame2, "RTLChannel4bin", anchor="e")
...
make_section_info_button(frame1, "pulsar_det_an", anchor="e")
...
pulplot_frame.rowconfigure(0, weight=1)

make_section_info_button(pulplot_frame, "pul_plot", anchor="e")
